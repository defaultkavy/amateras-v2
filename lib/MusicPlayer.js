        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.channel) {
                if (this.message && !this.message.deleted) {
                    yield this.message.edit({ embeds: [embed.call(this)], components: components.call(this) });
                    return;
                }
                if (__classPrivateFieldGet(this, _MusicPlayer_data, "f") && __classPrivateFieldGet(this, _MusicPlayer_data, "f").message) {
                    try {
                        ...
                        if (message) {
                            ...
                            this.message = yield this.channel.send({ embeds: [embed.call(this)], components: components.call(this) });
                            yield this.save();
                        }
                    }
                    catch (err) {
