        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function embed() {
                ...
                if (this.queue[0] && !this.queue[0].music.updated) {
                    embed = {
                        author: {
                            name: lang_json_1._music_message_.app_name[lang] // 天照音乐
                        },
                        color: 'NAVY',
                        title: lang_json_1._music_message_.loading[lang],
                        description: lang_json_1._music_message_.app_hint[lang] // 在此频道发送 YouTube Music 链接即可播放音乐
                    };
                }
                    ...
                    embed = {
                        ...
                        title: music.title,
                        url: music.url,
                        description: `${this.queue[0].player.mention()} ${lang_json_1._music_message_.play_song[lang]}`,
                        image: {
                        ...
                        fields: [
                            {
                                name: `${lang_json_1._music_message_.system_played[lang]} ${music.plays} ${lang_json_1._unit_.times[lang]}`,
                                value: `${music.players} ${lang_json_1._music_message_.user_played[lang]}`,
                                inline: false
                            },
                            {
                                name: lang_json_1._music_message_.likes[lang],
                                value: `${music.likes.length} ${lang_json_1._unit_.persons[lang]}`,
                                inline: true
                            },
                            {
                                name: lang_json_1._music_message_.unlikes[lang],
                                value: `${music.dislikes.length} ${lang_json_1._unit_.persons[lang]}`,
                                inline: true
                            },
                            {
                                name: lang_json_1._music_message_.player_status[lang],
                                value: `${this.state === 'PLAYING' ? '▶️' : '⏸️'} ${this.repeatState === 'ALL' ? '🔁' : this.repeatState === 'ONE' ? '🔂' : ''} - ${this.repeatState === 'ALL' ? this.queue.length + this.prevQueue.length : this.queue.length} ${lang_json_1._music_message_.in_queue[lang]}`,
                                inline: true
                            }
                        ]
                    };
                    ...
                    embed = {
                        author: {
                            name: lang_json_1._music_message_.app_name[lang]
                        },
                        color: 'DARK_BUT_NOT_BLACK',
                        title: __classPrivateFieldGet(this, _MusicPlayer_amateras, "f").ready ? lang_json_1._music_message_.empty_queue[lang] : lang_json_1._system_.sleeping[lang],
                        description: lang_json_1._music_message_.app_hint[lang]
                    };
                }
                return embed;
            }
            function components() {
                ...
                actionRow1.addComponents({
                    label: lang_json_1._music_message_.player_play[lang],
                    style: `PRIMARY`,
                    customId: `music_play`,
                ...
                actionRow1.addComponents({
                    label: lang_json_1._music_message_.player_pause[lang],
                    style: `SECONDARY`,
                ...
                actionRow1.addComponents({
                    label: lang_json_1._music_message_.player_stop[lang],
                    style: `SECONDARY`,
                    customId: `music_stop`,
                    disabled: this.state === 'STOPPED' ? true : false,
                    type: 'BUTTON'
                ...
                actionRow2.addComponents({
                    label: lang_json_1._music_message_.player_prev[lang],
                    style: `SECONDARY`,
                    customId: `music_prev`,
                ...
                actionRow2.addComponents({
                    label: lang_json_1._music_message_.player_next[lang],
                    style: `SECONDARY`,
                    customId: `music_next`,
                ...
                actionRow2.addComponents({
                    label: lang_json_1._music_message_.player_repeat[lang],
                    style: `SECONDARY`,
