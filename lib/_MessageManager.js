...
class _MessageManager {
    constructor(amateras) {
        ...
        __classPrivateFieldSet(this, __MessageManager_collection, amateras.db.collection('messages'), "f");
        this.cache = new Map;
    }
    fetch(msgId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const msgData = yield __classPrivateFieldGet(this, __MessageManager_collection, "f").findOne({ id: msgId });
            if (!msgData)
                return;
