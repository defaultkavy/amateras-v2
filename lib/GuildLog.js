...
class GuildLog {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function embed() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const embed = {
                        title: __classPrivateFieldGet(this, _GuildLog_amateras, "f").ready ? lang_json_1.log_init.sleeping[lang] : lang_json_1.log_init.sleeping[lang],
                        description: lang_json_1.log_init.description[lang],
                        color: __classPrivateFieldGet(this, _GuildLog_amateras, "f").ready ? 'GREEN' : 'GREY',
                        fields: [
                            {
                                name: lang_json_1.log_init.join_date[lang],
                                value: member ? member.joinedTimestamp ? (0, terminal_1.timestampDate)(member.joinedTimestamp) : '-' : '-',
                                inline: true
                            },
                            {
                                name: lang_json_1.log_init.start_time[lang],
                                value: `${(0, terminal_1.timestampDate)(__classPrivateFieldGet(this, _GuildLog_amateras, "f").system.uptime)}`,
                                inline: true
                            },
                            {
                                name: lang_json_1.log_init.logs[lang],
    ...
    fetchLog() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const messageCheck = () => __awaiter(this, void 0, void 0, function* () { return this.logMessage ? (yield this.logMessage.fetch().catch(() => undefined)) ? this.newMessage() : this.logMessage : messageFetch(); });
