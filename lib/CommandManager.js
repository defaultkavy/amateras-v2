...
var _CommandManager_amateras, _CommandManager_commands;
...
class CommandManager {
    constructor(amateras) {
        ...
        __classPrivateFieldSet(this, _CommandManager_commands, global_commands, "f");
    }
    init() {
...
_CommandManager_amateras = new WeakMap(), _CommandManager_commands = new WeakMap();
