...
class Wallet {
    constructor(wallet, amateras) {
        ...
        __classPrivateFieldSet(this, _Wallet_collection, (_a = amateras.db) === null || _a === void 0 ? void 0 : _a.collection('wallets'), "f");
        this.id = wallet.id;
    ...
    transfer(receiver, amount, note, devote) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            terminal_1.cmd.log(`${this.id} transfer ${amount}G to ${receiver}`);
