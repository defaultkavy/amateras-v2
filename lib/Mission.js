    ...
    complete() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.agents.length < this.persons) {
                yield __classPrivateFieldGet(this, _Mission_amateras, "f").me.wallets[0].transfer(this.owner.wallets[0].id, (this.persons - this.agents.length) * this.pay, `Mission payment remains.`, false);
