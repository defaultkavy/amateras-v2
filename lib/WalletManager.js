...
class WalletManager {
    constructor(amateras) {
        ...
        __classPrivateFieldSet(this, _WalletManager_collection, amateras.db.collection('wallets'), "f");
        this.cache = new Map();
    }
    fetch(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (wallet) {
                ...
                const walletData = yield __classPrivateFieldGet(this, _WalletManager_collection, "f").findOne({ id: id });
                if (walletData) {
                    const wallet = new Wallet_1.default(walletData, __classPrivateFieldGet(this, _WalletManager_amateras, "f"));
