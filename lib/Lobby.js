...
var _Lobby_amateras, _Lobby_collection, _Lobby_data, _Lobby__guild, _Lobby_categoryChannel, _Lobby_voiceChannel, _Lobby_textChannel, _Lobby_infoChannel, _Lobby_owner, _Lobby_member, _Lobby_vFolder, _Lobby_manager, _Lobby_messages;
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error('Lobby delete channel failed. \n' + err);
            }
            this.state = 'CLOSED';
            if (this.lobbyMessage && !this.lobbyMessage.deleted)
