...
class Lobby {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this.categoryChannel = (yield __classPrivateFieldGet(this, _Lobby__guild, "f").get.channels.fetch(__classPrivateFieldGet(this, _Lobby_data, "f").categoryChannel));
                this.voiceChannel = (yield __classPrivateFieldGet(this, _Lobby__guild, "f").get.channels.fetch(__classPrivateFieldGet(this, _Lobby_data, "f").voiceChannel));
                this.textChannel = (yield __classPrivateFieldGet(this, _Lobby__guild, "f").get.channels.fetch(__classPrivateFieldGet(this, _Lobby_data, "f").textChannel));
                this.infoChannel = (yield __classPrivateFieldGet(this, _Lobby__guild, "f").get.channels.fetch(__classPrivateFieldGet(this, _Lobby_data, "f").infoChannel));
            }
            catch (err) {
                this.state = 'CLOSED';
                yield this.save();
