...
class Lobby {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this.categoryChannel = (yield __classPrivateFieldGet(this, _Lobby__guild, "f").get.channels.fetch(__classPrivateFieldGet(this, _Lobby_categoryChannel, "f")));
                this.voiceChannel = (yield __classPrivateFieldGet(this, _Lobby__guild, "f").get.channels.fetch(__classPrivateFieldGet(this, _Lobby_voiceChannel, "f")));
                this.textChannel = (yield __classPrivateFieldGet(this, _Lobby__guild, "f").get.channels.fetch(__classPrivateFieldGet(this, _Lobby_textChannel, "f")));
                this.infoChannel = (yield __classPrivateFieldGet(this, _Lobby__guild, "f").get.channels.fetch(__classPrivateFieldGet(this, _Lobby_infoChannel, "f")));
            }
            catch (_a) {
