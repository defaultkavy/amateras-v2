    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const guild of guilds.values()) {
                ...
                if (_guildData) {
                    // Guild data exist
                    const _guild = new _Guild_1._Guild(_guildData, guild, __classPrivateFieldGet(this, __GuildManager_amateras, "f"));
                    ...
                    const _guild = new _Guild_1._Guild(_newGuildData, guild, __classPrivateFieldGet(this, __GuildManager_amateras, "f"));
                    yield _guild.init();
                    yield _guild.save();
                }
            }
