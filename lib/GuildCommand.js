...
class GuildCommand {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (__classPrivateFieldGet(this, _GuildCommand_amateras, "f").debug === true)
                return;
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            data.guild = __classPrivateFieldGet(this, _GuildCommand__guild, "f").id;
            const guild = yield __classPrivateFieldGet(this, _GuildCommand_collection, "f").findOne({ id: this.id, guild: __classPrivateFieldGet(this, _GuildCommand__guild, "f").id });
            if (guild) {
                yield __classPrivateFieldGet(this, _GuildCommand_collection, "f").replaceOne({ id: this.id, guild: __classPrivateFieldGet(this, _GuildCommand__guild, "f").id }, data);
            }
            else {
