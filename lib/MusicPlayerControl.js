...
class MusicPlayerControl {
    ...
    play() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!__classPrivateFieldGet(this, _MusicPlayerControl_player, "f").queue[0])
                return;
            yield __classPrivateFieldGet(this, _MusicPlayerControl_player, "f").queue[0].music.update();
            __classPrivateFieldGet(this, _MusicPlayerControl_player, "f").queue[0].resource = (0, ytdl_core_1.default)(__classPrivateFieldGet(this, _MusicPlayerControl_player, "f").queue[0].music.url, { filter: 'audioonly', highWaterMark: 1 << 25 }); //, {format: ytdl.chooseFormat(info.formats, { quality: '140' })}) //
            ...
            yield __classPrivateFieldGet(this, _MusicPlayerControl_player, "f").queue[0].music.record();
            __classPrivateFieldGet(this, _MusicPlayerControl_player, "f").initMessage();
        });
    }
    next() {
        ...
        if (__classPrivateFieldGet(this, _MusicPlayerControl_player, "f").audioPlayer) {
            if (__classPrivateFieldGet(this, _MusicPlayerControl_player, "f").audioPlayer.state.status === 'idle') {
                this.play();
            }
            else {
    ...
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield __classPrivateFieldGet(this, _MusicPlayerControl_player, "f").initMessage();
        });
    }
    pause() {
        return __awaiter(this, void 0, void 0, function* () {
