...
var __Role_amateras, __Role__guild;
Object.defineProperty(exports, "__esModule", { value: true });
exports._Role = void 0;
const Player_1 = require("./Player");
const V_1 = require("./V");
class _Role {
    constructor(role, _guild, amateras) {
        __Role_amateras.set(this, void 0);
        __Role__guild.set(this, void 0);
        __classPrivateFieldSet(this, __Role_amateras, amateras, "f");
        __classPrivateFieldSet(this, __Role__guild, _guild, "f");
        this.id = role.id;
        this.get = role;
    ...
    fetch() {
        return __awaiter(this, void 0, void 0, function* () {
            const fetch = yield __classPrivateFieldGet(this, __Role__guild, "f").get.roles.fetch(this.id).catch(() => undefined);
            // If role deleted, unset default role automatic
            if (!fetch) {
                __classPrivateFieldGet(this, __Role__guild, "f").roles.unsetDefaultRole(this.id);
            }
            return fetch;
        });
    }
...
exports._Role = _Role;
__Role_amateras = new WeakMap(), __Role__guild = new WeakMap();
