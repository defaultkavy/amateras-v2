...
class Player {
    ...
    sendInfo(interaction, share) {
        return __awaiter(this, void 0, void 0, function* () {
            const member = interaction.guild ? yield interaction.guild.members.fetch(this.id).catch(() => undefined) : undefined;
            const embed = yield this.infoEmbed(member);
            // Create Button
            const comp = [];
            if (this.v && share) {
    ...
    infoEmbed(member) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.get)
                return {};
            const joinedGuildDate = member ? member.joinedTimestamp ? (0, terminal_1.timestampDate)(member.joinedTimestamp) : undefined : undefined;
            const joinedSystemDate = (0, terminal_1.timestampDate)(this.joinedDate);
            if (this.bot) {
