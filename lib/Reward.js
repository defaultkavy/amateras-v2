...
class Reward {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            const player = yield __classPrivateFieldGet(this, _Reward_amateras, "f").players.fetch(__classPrivateFieldGet(this, _Reward_owner, "f"));
            if (player === 404)
                return;
            this.owner = player;
        });
    ...
    add() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.count >= this.reach) {
                ...
                __classPrivateFieldGet(this, _Reward_amateras, "f").log.send(`${yield __classPrivateFieldGet(this, _Reward_amateras, "f").log.name(this.owner.id)} `, lang_json_1._reward_.get_reward, ` ${this.pay}G`);
            }
            yield this.save();
        });
    }
