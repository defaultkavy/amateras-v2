...
var __Guild_amateras, __Guild_collection, __Guild_manager;
...
class _Guild {
    constructor(data, guild, manager, amateras) {
        ...
        this.forums = new ForumManager_1.ForumManager(data.forums, this, __classPrivateFieldGet(this, __Guild_amateras, "f"));
        this.roles = new _RoleManager_1._RoleManager(data.roles, this, __classPrivateFieldGet(this, __Guild_amateras, "f"));
        this.channels = new _ChannelManager_1._ChannelManager(data.channels, this, __classPrivateFieldGet(this, __Guild_amateras, "f"));
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            this.amateras = yield this.get.members.fetch(__classPrivateFieldGet(this, __Guild_amateras, "f").id).catch(() => undefined);
            console.log(cmd_1.default.Green, `Guild Initializing: ${this.get.name}`);
            ...
            yield this.save();
            console.log(cmd_1.default.Green, `Guild Initialized: ${this.get.name}`);
            this.ready = true;
        });
    }
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            const data = (0, terminal_1.cloneObj)(this, ['get', 'roles', 'musicPlayer', 'ready', 'amateras']);
    ...
    setLanguage(lang) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.lang === lang)
                return 101;
            this.lang = lang;
            yield this.log.initMessage();
            yield this.musicPlayer.initMessage();
            yield this.lobby.updateInitMessage();
            yield this.save();
            return 100;
        });
    }
...
__Guild_amateras = new WeakMap(), __Guild_collection = new WeakMap(), __Guild_manager = new WeakMap();
