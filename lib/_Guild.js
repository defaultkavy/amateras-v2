...
var __Guild_amateras, __Guild_collection, __Guild_lobby, __Guild_forums;
...
class _Guild {
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            const data = (0, terminal_1.cloneObj)(this, ['get', 'roles']);
...
__Guild_amateras = new WeakMap(), __Guild_collection = new WeakMap(), __Guild_lobby = new WeakMap(), __Guild_forums = new WeakMap();
