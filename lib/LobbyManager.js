...
var _LobbyManager_amateras, _LobbyManager_collection, _LobbyManager__guild, _LobbyManager_lobbies, _LobbyManager_channel, _LobbyManager_message, _LobbyManager_resolve;
...
class LobbyManager {
    constructor(data, _guild, amateras) {
        ...
        _LobbyManager_lobbies.set(this, void 0);
        ...
        this.channel = {};
        __classPrivateFieldSet(this, _LobbyManager_lobbies, data.lobbies, "f");
        this.cache = new Map;
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (__classPrivateFieldGet(this, _LobbyManager_lobbies, "f") && __classPrivateFieldGet(this, _LobbyManager_lobbies, "f").length !== 0) {
                for (const lobbyId of __classPrivateFieldGet(this, _LobbyManager_lobbies, "f")) {
...
_LobbyManager_amateras = new WeakMap(), _LobbyManager_collection = new WeakMap(), _LobbyManager__guild = new WeakMap(), _LobbyManager_lobbies = new WeakMap(), _LobbyManager_channel = new WeakMap(), _LobbyManager_message = new WeakMap(), _LobbyManager_resolve = new WeakMap();
