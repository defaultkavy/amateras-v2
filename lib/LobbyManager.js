...
class LobbyManager {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!__classPrivateFieldGet(this, _LobbyManager_data, "f"))
                return 101;
            try {
                if (!__classPrivateFieldGet(this, _LobbyManager_data, "f").channel)
                    return 101;
                const _channel = yield __classPrivateFieldGet(this, _LobbyManager__guild, "f").channels.fetch(__classPrivateFieldGet(this, _LobbyManager_data, "f").channel);
                ...
                try {
                    if (this.message) {
                        ...
                        if (!this.thread) {
                            this.thread = yield this.message.startThread({ name: `房间列表`, autoArchiveDuration: 60 });
                        }
                    }
                }
                catch (_b) {
                ...
                if (__classPrivateFieldGet(this, _LobbyManager_data, "f").lobbies && __classPrivateFieldGet(this, _LobbyManager_data, "f").lobbies[0]) {
                    for (const lobbyId of __classPrivateFieldGet(this, _LobbyManager_data, "f").lobbies) {
                        ...
                        if (lobbyData) {
                            ...
                            if ((yield lobby.init()) !== 100) {
                                this.cache.delete(lobbyId);
                                continue;
                            }
                            if (lobby.categoryChannel)
    ...
    fetch(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lobbyData = yield __classPrivateFieldGet(this, _LobbyManager_collection, "f").findOne({ owner: id, state: "OPEN", guild: __classPrivateFieldGet(this, _LobbyManager__guild, "f").id });
            if (lobbyData) {
                const lobby = new Lobby_1.Lobby(lobbyData, __classPrivateFieldGet(this, _LobbyManager__guild, "f"), this, __classPrivateFieldGet(this, _LobbyManager_amateras, "f"));
    ...
    fetchByCategory(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lobbyData = yield __classPrivateFieldGet(this, _LobbyManager_collection, "f").findOne({ categoryChannel: id, state: "OPEN", guild: __classPrivateFieldGet(this, _LobbyManager__guild, "f").id });
            if (lobbyData) {
                const lobby = new Lobby_1.Lobby(lobbyData, __classPrivateFieldGet(this, _LobbyManager__guild, "f"), this, __classPrivateFieldGet(this, _LobbyManager_amateras, "f"));
    ...
    toData() {
        const data = (0, terminal_1.cloneObj)(this, ['cache', 'thread']);
    ...
    sendInitMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.channel)
                return 101;
            const lang = __classPrivateFieldGet(this, _LobbyManager__guild, "f").lang;
            const embed = this.initEmbed();
            const create_button = new discord_js_1.MessageButton;
            create_button.label = lang_json_1._lobby_init_.lobby_create[lang];
            create_button.customId = '#lobby_create';
            create_button.style = 'PRIMARY';
            const close_button = new discord_js_1.MessageButton;
            close_button.label = lang_json_1._lobby_init_.lobby_close[lang];
            ...
            this.thread = yield this.message.startThread({ name: lang_json_1._lobby_init_.lobby_thread[lang], autoArchiveDuration: 60 });
        });
    }
    updateInitMessage() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    initEmbed() {
        const lang = __classPrivateFieldGet(this, _LobbyManager__guild, "f").lang;
        const embed = {
            title: lang_json_1._lobby_init_.title[lang],
            description: lang_json_1._lobby_init_.description[lang],
            fields: [
                {
                    name: lang_json_1._lobby_init_.room_count[lang],
