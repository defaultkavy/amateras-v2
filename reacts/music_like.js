...
function music_like(interact, amateras) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (result === 100) {
            _guild.musicPlayer.notify.push(player, lang_json_1._music_button_.add_like[lang], 3000);
            return;
        }
        else {
            playerMusic.unsetLike();
            _guild.musicPlayer.notify.push(player, lang_json_1._music_button_.remove_like[lang], 3000);
        }
    });
}
